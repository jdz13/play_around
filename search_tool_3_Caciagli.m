function [SaveVar] = search_tool_3_Caciagli(KRV,RES,pm_cl,Lengths,theta,Yin,Zin,s_rad,con)
...
SWres = zeros(size(KRV,2),ntestmax,length(pm_cl),length(RES), length(Lengths)); SHo = SWres;
